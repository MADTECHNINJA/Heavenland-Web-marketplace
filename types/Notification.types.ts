...
export type MessageParam = {
    entity: string;
    value: string | number;
    renderFn?: (value: string | number) => string;
...
export class Notification {
    ...
    constructor(params: NotificationParams, id: number) {
        ...
        this.indefinite = params.indefinite ?? false;
...
export type NotificationClaimParagons = {
    [mint: string]: {
        name: string;
        breedingParagons?: string[];
        state: ParallelDataState;
        tx: web3.Transaction;
        link?: Link;
    };

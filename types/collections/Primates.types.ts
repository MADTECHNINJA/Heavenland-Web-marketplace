...
export enum EPrimateSymbol {
    PRIMATE = 'PRIM',
}

export interface IPrimateBase extends INftBase {
    readonly id: string;
...
export class Primates implements IPrimateBase, IStampable {
    ...
    constructor(onChain: OnChainMetadata, offChain: OffChainMetadata) {
        ...
        this.cname = CollectionName.PRIMATES;

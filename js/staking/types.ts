...
export const STAKING_PROGRAM_ID = new PublicKey(import.meta.env.VITE_HL_STAKING_PROGRAM_ADDRESS);
export const REWARD_VAULT = new PublicKey(import.meta.env.VITE_HL_STAKING_REWARD_VAULT);
export const GLOBAL_AUTHORITY_SEED = 'global-pool';
export const NFT_INFO_SEED = 'nft-info';
export const ROLE_INFO_SEED = 'role-info';

export const BASE_STAKING_PERIOD = import.meta.env.VITE_HL_STAKING_BASE_PERIOD;

...
export const useCollectionStore = defineStore({
    ...
    state: () => ({
        metadata: {
            parcels: new DataWrapper<CollectionMetadata>(),
            loyalties: new DataWrapper<CollectionMetadata>(),
            solamids: new DataWrapper<CollectionMetadata>(),
            alphas: new DataWrapper<CollectionMetadata>(),
            paragons: new DataWrapper<CollectionMetadata>(),

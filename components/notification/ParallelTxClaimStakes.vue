        ...
        <div v-for="(stakes, _, index) in data.stakes" :key="index" class="text-xs flex flex-col">
            <div class="inline-block mr-1">
                <p class="text-gray-300">
                    ...
                    <img :src="htoCurrency" alt="HTO" class="h-3.5 ml-1 mb-1 rounded-full inline-block" />
                </p>
            </div>
            <div v-for="stake in stakes.stakes" :key="stake.claim" class="ml-3 mt-1 text-xs flex items-center">
                <div class="flex items-center">
                    <AppSpinner v-if="stake.state === ParallelDataState.PROCESSING" class="h-3 w-3 mr-1.5" />
                    <FontAwesomeIcon
                        v-else
                    ...
                    <img :src="htoCurrency" alt="HTO" class="h-3.5 ml-1 rounded-full inline-block" />

                    <NuxtLink v-if="stake.link" :to="stake.link.href" target="_blank" class="ml-3 -mt-0.5">
                        <span class="hyperlink text-sm text-white" />

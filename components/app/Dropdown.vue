    ...
    <Menu as="div" class="relative w-full md:mt-0 text-left">
        <div class="text-left w-full flex">
            <MenuButton
                :class="[
                    ...
                    isSmall && 'text-xs',
                    orderedBy ? 'rounded-l-md' : 'rounded-md',
                ]"
        ...
        >
            <MenuItems
                ...
                class="origin-top-left justify-center lg:justify-center items-center absolute z-[50] left-0 mt-2 rounded-md shadow-lg bg-indigo-920 ring-1 ring-black ring-opacity-5 divide-y divide-gray-100 focus:outline-none"
            >
                            ...
                            <a
                                ...
                                :class="[
                                    active || isSelected(item)
                                        ? 'bg-indigo-930  shadow-md rounded-md text-white'
                                        : 'text-gray-400',

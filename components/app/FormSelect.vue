    ...
    <Listbox v-model="selected" as="div">
        <div class="relative z-10">
            <ListboxButton
                ...
                "
                class="py-1.5 bg-[#07072f] cursor-pointer outline-none appearance-none block w-full h-full md:pl-5 sm:text-sm rounded-md"
            >
            ...
            >
                <ListboxOptions
                    class="absolute z-10 mt-2.5 w-full shadow-xl border border-white border-opacity-20 m-2 bg-[#07072f] max-h-56 rounded-lg text-base ring-1 ring-black ring-opacity-5 overflow-auto focus:outline-none sm:text-sm"
                >
                    <ListboxOption
                        as="template"
                        v-for="item in items"

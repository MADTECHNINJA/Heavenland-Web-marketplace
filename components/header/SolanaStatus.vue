<template>
    <div
        id="solanaStatusDiv"
        class="lg:bg-indigo-930 w-full md:w-auto justify-center lg:justify-start px-3 h-[36px] items-center rounded-lg text-gray-300-600 text-xs font-semibold lg:flex flex"
    >

<template>
    ...
    >
        <div class="relative">
            ...
            >
                <div v-if="item.image" class="flex items-center h-full" :class="{ 'bg-black': loaded }">
                    <img
                        v-if="item.image"
...
<script lang="ts" setup>
    ...
    import parcelCollectionBg from '@/assets/collections/heavenland-parcels.png';
    import solamidCollectionBg from '@/assets/collections/solamids.png';
    ...
    const stakingBgImage = computed(() => {
        switch (props.item.cname) {
            case CollectionName.SOLAMIDS:
                return solamidCollectionBg;

            default:
                return parcelCollectionBg;
        }
    });
